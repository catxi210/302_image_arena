...
export const MODEL_LIST: ModelInfo[] = [
  ...
  // Kling Models
  { id: "kolors", name: "Kolors", alias: "K", group: "Kling", icon: Kling },
  ...
  // Fal Models
  { id: "aura-flow", name: "Auraflow", alias: "AF", group: "Fal", icon: Fal },
  ...
  // Doubao Models
  {
    id: "doubao-general-v2.1-l",
    name: "Doubao General V2.1 L",
    alias: "DG2.1L",
    group: "Doubao",
    icon: Doubao,
  },
  {
    id: "doubao-general-v2.0-l",
    name: "Doubao General V2.0 L",
    alias: "DG2.0L",
    group: "Doubao",
    icon: Doubao,
  },
  {
    id: "doubao-general-v2.0",
    name: "Doubao General V2.0",
    alias: "DG2.0",
    group: "Doubao",
    icon: Doubao,
  },
